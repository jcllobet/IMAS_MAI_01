 ...
 * from the Cleaner Coordinator agent. The Cleaner Coordinator agent sends a REQUEST of the whole
...
public class RequestResponseBehaviour extends AchieveREResponder {
     ...
     */
    public RequestResponseBehaviour(CleanerCoordinatorAgent agent, MessageTemplate mt) {
        super(agent, mt);
